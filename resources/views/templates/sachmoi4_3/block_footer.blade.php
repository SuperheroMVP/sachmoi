        ...
        <div class="col-md-5 mb-sm--30">
          <div class="subscription-text">
            ...
            <div class="subscription-text__right">
              <h3 class="color--white">{{ trans('front.subscribe.title') }}</h3>
              <p class="color--white">{{ trans('front.subscribe.subscribe_des') }}</p>
            </div>
          </div>
        </div>
        <div class="col-md-7">
          <form class="newsletter-form validate" action="{{ sc_route('subscribe') }}" method="post" >
            @csrf
            <input type="email" class="newsletter-form__input" name="subscribe_email" id="subscribe-form-2-email" placeholder="{{ trans('front.subscribe.subscribe_email') }}.." required>
...
<a class="scroll-to-top" href="" style="background: #9fd84a!important;"><i class="fa fa-angle-up"></i></a>