...
{{--                                                    {{dd($shipping)}}--}}
                                                    <div class="form-check">
                                                        ...
                                                        <label class="radio-inline" for="payment-{{ $shipping['key'] }}">
                                                            <span><img src="{{asset($shipping['image']) }}" width="45px" alt="{{$shipping['title']}}"><span class="title-payment">{{$shipping['title']}}</span></span> 
                                                ...
                                                @foreach ($paymentMethod as $key => $payment)
                                                    ...
                                                    <div class="form-check mt-2 mb-2">
                                                            ...
                                                            <label class="radio-inline" for="payment-{{ $payment['key'] }}">
                                                                <span><img src="{{asset($payment['image']) }}" width="45px" alt="{{$payment['title']}}"><span class="title-payment">{{$payment['title']}}</span></span>
                                                            </label>                                                                                      </div>
                                                @endforeach
                                                <div>
