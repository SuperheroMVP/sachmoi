...
{{--                                                <span class="count">(10)</span>--}}
                                                <ul class="children">
                                                    ...
                                                    <li class="cat-item">
                                                        <a href="{{$cateChild->getUrl()}}">{{$cateChild->title}}
                                                        </a>
                                                        <span class="count">({{count($cateChild->productDescription)}})
                                                        </span>
                                                        @if(!empty($categories[$cateChild->id]))
                                                             <ul class="children mt-2 mb-2">
                                                                
                                                                @foreach($categories[$cateChild->id] as $cateChild2)
                                                                <li class="cat-item">
                                                                    <a href="{{$cateChild2->getUrl()}}">-{{$cateChild2->title}}</a>
                                                                    <span class="count">({{count($cateChild2->productDescription)}})
                                                                    </span>                                        
                                                                </li>
                                                                @endforeach
