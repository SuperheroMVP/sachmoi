                    ...
                    <div class="col-12">
                        <div class="apply-coupon-wrapper bg-white">
                            <div class="form__group d-flex justify-content-between flex-sm-row flex-column">
                                <button onClick="location.href='{{ sc_route('product.all') }}'" type="button" class="btn btn-5 btn-style-1 color-1"><i class="fa fa-arrow-left"></i>  {{ trans('cart.back_to_shop') }}</button>
