...
@section('block_main')
    <div class="modal fade bd-example-modal-lg" id="myModal_Home" tabindex="-1" role="dialog">
        <div class="modal-dialog model-homepage" role="document">
            <div class="modal-content model-homepage">
                <div class="modal-header">
                    <h5 class="modal-title">Sachmoi.vn</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
{{--                    <img  class="img-fluid" src="https://kennatech.vn/storage/banners/August2020/8atyjo8BVZhtJFsGlCdG.jpg" alt="">--}}
                    <img class="img-fluid" src="public/images/sell_website2.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
...
{{--                                                <span class="sale-price">{{'Số lượng :' . $productsNew[$i]->stock }}</span>--}}
                                            ...
                                            <div class="product-box__price product__new">
{{--                                                <span class="sale-price">{{ $productsNew[$i]->price .'đ' }}</span>--}}
                                                <span class="sale-price">{!! $productsNew[$i]->showPrice() !!}</span>
                                            </div>
                                        </div>
...
{{--                                                <span class="sale-price">{{ $productsNew[$i+1]->price .'đ' }}</span>--}}
                                                <span class="sale-price">{!! $productsNew[$i+1]->showPrice() !!}</span>
                                            </div>
                                        </div>
                                        <div class="product-box__action action-1">
                                            <a onClick="addToCartAjax('{{ $productsNew[$i]->id }}','default')" class="add-to-cart" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add to cart"><i class="fa fa-shopping-bag"></i></a>
                                           ...
                                           <div class="row no-gutters equal-container ">
                                              <div class="col-lg-5 col-md-5 col-12 order-md-2 order-1 ">
                                                  ...
                                                  <div class="product-box limited-product bg--white color-3 ">
                                                      <div class="product-box__img product-first-img-home">
                                                      ...
                                                      @for($j=0;$j<count($cateChild->productDescription); $j++)
                                                          <div class="category-product-group">
                                                              <div class="product-box product-box-hover-down bg--white color-1 border-right border-bottom">
                                                                  <div class="product-box__img product-second-img-home">
                  ...
                  <div class="row">
                      @if($background->count()>0)
                          @foreach($background as $bg)
                              <div class="col-12">
                                  <div class="promo-box banner-background">
                              ...
                              @foreach ($productsHot as  $key => $product_hot)
                                  <div class="related-product">
                                      <div class="product-box product-box-hover-down bg--white color-1">
                                          <div class="product-box__img">
                                              <img src="{{ asset($product_hot->getImage()) }}" alt="product" class="primary-image">
                                              <img src="{{ asset($product_hot->getImage()) }}" alt="product" class="secondary-image">
                                              <a href="{{$product_hot->getUrl()}}" data-toggle="modal" data-target="#productModal" class="product-box__quick-view"><i class="fa fa-search"></i></a>
                                          </div>
                                          <div class="product-box__content">
                                              <h3 class="product-box__title"><a href="{{$product_hot->getUrl()}}">{{$product_hot->name}}</a></h3>

                                              <div class="product-box__price">
{{--                                                  {{dd($product_hot)}}--}}
                                                  {!! $product_hot->showPrice() !!}
{{--                                                 {!! $product_hot->showPercentPrice() !!}--}}
                                              </div>
                                          </div>
                                          <div class="product-box__action action-2">
                                              <a onClick="addToCartAjax('{{ $product_hot->id }}','wishlist')" class="add-to-wishlist" data-toggle="tooltip" data-placement="top" title="{{trans('front.add_to_wishlist')}}"><i class="fa fa-heart-o"></i></a>
                                              <a onClick="addToCartAjax('{{ $product_hot->id }}','default')"  class="add-to-cart" data-toggle="tooltip" data-placement="top" title="{{trans('front.add_to_cart')}}"><i class="fa fa-shopping-bag"></i>{{trans('front.add_to_cart')}}</a>
                                              <a onClick="addToCartAjax('{{ $product_hot->id }}','compare')" class="add-to-compare" data-toggle="tooltip" data-placement="top" title="{{trans('front.compare_page')}}"><i class="fa fa-refresh"></i></a>
                                          </div>
                                      </div>
                                  </div>
                              @endforeach
