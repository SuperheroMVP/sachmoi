                                            ...
                                            <div>
                                                <label class="radio-inline">
                                                    <img 
                                                        ...
                                                        src="{{ asset($paymentMethodData['image']) }}" width="50px" 
                                                      > 
                                                      <span>{{ $paymentMethodData['title'] }}</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                         ...
                         <div class="pull-left">
                            <button class="btn btn-default" type="button" style="cursor: pointer;padding:10px 30px" onClick="location.href='{{ sc_route('cart') }}'"><i class="fa fa-arrow-left"></i>{{ trans('cart.back_to_cart') }}</button>
                                ...
                                <div class="pull-right">
                                    <button class="btn btn-warning" id="submit-order" type="submit" style="cursor: pointer;padding:10px 30px"><i class="fa fa-check"></i> {{ trans('cart.confirm') }}</button>
                                </div>
                        </div>
                    </div>
