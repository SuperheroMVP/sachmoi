...
@if (!sc_config('author'))
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    ...
                    <input type="text" style="width: 100px;" id="author" name="author"
                           value="{!! old('author',$product->author) !!}" class="form-control cost"
                           placeholder="" />
                </div>
    ...
    {{-- //Cost --}}
@endif
@if (!sc_config('formality'))
    {{-- formality --}}
    @if ($product->kind == SC_PRODUCT_SINGLE)
        <div class="form-group row kind kind0 kind1  {{ $errors->has('formality') ? ' text-red' : '' }}">
            <label for="cost" class="col-sm-2 col-form-label">Hình Thức</label>
            <div class="col-sm-8">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                    ...
                    <input type="text" style="width: 100px;" id="formality" name="formality"
                           value="{!! old('formality',$product->formality) !!}" class="form-control cost"
                           placeholder="" />
                </div>
