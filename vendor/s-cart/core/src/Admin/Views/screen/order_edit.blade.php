...
{{--                     <tr>
                    ...
                    @endif --}}
                      <tr>
                         <td class="td-title">Địa chỉ:</td><td><a href="#" class="updateInfoRequired" data-name="address" data-type="text" data-pk="{{ $order->id }}" data-url="{{ route("admin_order.update") }}" data-title="Địa chỉ" >{!! $order->address !!}</a></td>
                     </tr>

                     <tr>
                         <td class="td-title">Xã/Phường/Thị trấn:</td><td><a href="#" class="updateInfoRequired" data-name="ward" data-type="text" data-pk="{{ $order->id }}" data-url="{{ route("admin_order.update") }}" data-title="Xã/Phường/Thị trấn" >{!! $order->ward !!}</a></td>
                     </tr>

                     <tr>
                         <td class="td-title">Quận/Huyện:</td><td><a href="#" class="updateInfoRequired" data-name="district" data-type="text" data-pk="{{ $order->id }}" data-url="{{ route("admin_order.update") }}" data-title="Quận/Huyện" >{!! $order->district !!}</a></td>
                     </tr>

                     <tr>
                         <td class="td-title">Tỉnh/Thành:</td><td><a href="#" class="updateInfoRequired" data-name="province" data-type="text" data-pk="{{ $order->id }}" data-url="{{ route("admin_order.update") }}" data-title="Tỉnh/Thành" >{!! $order->province !!}</a></td>
                     </tr>
