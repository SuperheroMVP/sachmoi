              ...
              <div class="row">
                <div class="col-md-7">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td class="no-border"><i class="fas fa-map"></i>Bản đồ</td>
                        <td><a href="#" class="editable-required editable editable-click edit_map" data-name="map" data-type="text" data-pk="" data-source="" data-url="{{ route('admin_store.update') }}" data-title="map" data-value="{{ $store->map }}" data-original-title="" title="">{{$store->map}}</a></td>
                    </tr>
