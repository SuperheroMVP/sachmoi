    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header with-border">
                    ...
                    <div class="card-tools">
                        <div class="btn-group float-right mr-5">
                            <a href="{{ sc_route('admin_product.index') }}" class="btn  btn-flat btn-default"
                               title="List">
                ...
                <!-- form start -->
                <form action="{{ sc_route('admin_product.create') }}" method="post" name="form_name"
                      accept-charset="UTF-8"
                      class="form-horizontal" id="form-main" enctype="multipart/form-data">

                    <div class="d-flex d-flex justify-content-center mb-3 {{ $errors->has('kind') ? ' text-red' : '' }}"
                         id="start-add">
                    ...
                    <div id="main-add" class="card-body {{ 'kind'.$kindOpt }}">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control input-sm category_store_id select2" style="width: 100%;"
                                        ...
                                        @foreach ($categoriesStore as $k => $v)
                                            <option value="{{ $k }}" {{ (old('category_store_id') == $k) ? 'selected':'' }}>{{ $v }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group row kind kind0 kind1 {{ $errors->has('image') ? ' text-red' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <span class="btn btn-primary lfm" data-input="image"
                                              data-preview="preview_image" data-type="product">
                        ...
                        @if (sc_config_admin('product_supplier'))
                            ...
                            {{-- //select brand --}}
                        @endif
                        <div class="form-group row kind kind0 kind1  {{ $errors->has('author') ? ' text-red' : '' }}">
                            <label for="cost" class="col-sm-2 col-form-label">Tác giả</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                    </div>
                                    <input type="text" style="width: 100px;" id="author" name="author"
                                           value="{!! old('author')??'' !!}" class="form-control input-sm cost"
                                           placeholder=""/>
                                </div>
                                @if ($errors->has('author'))
                                    <span class="form-text">
                                    <i class="fa fa-info-circle"></i> {{ $errors->first('author') }}
                                </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group row kind kind0 kind1  {{ $errors->has('formality') ? ' text-red' : '' }}">
                            <label for="cost" class="col-sm-2 col-form-label">Hình thức bìa</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                    </div>
                                    <input type="text" style="width: 100px;" id="formality" name="formality"
                                           value="{!! old('formality')??'' !!}" class="form-control input-sm cost"
                                           placeholder=""/>
                                </div>
                                @if ($errors->has('formality'))
                                    <span class="form-text">
                                    <i class="fa fa-info-circle"></i> {{ $errors->first('formality') }}
                                </span>
                                @endif
                            </div>
                        </div>
                        ...
                        @if (sc_config_admin('product_property'))
                            ...
                            <div class="form-group row kind kind0 kind1  {{ $errors->has('property') ? ' text-red' : '' }}">
                                <label for="property"
                                       class="col-sm-2 col-form-label">{{ trans('product.property') }}</label>
                                <div class="col-sm-8">
                                    @foreach ( $propertys as $key => $property)
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="radioPrimary{{ $key }}" name="property"
                                                   value="{{ $key }}" {{ ((!old() && $key ==0) || old('property') == $key)?'checked':'' }}>
                            ...
                            <div
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="date" data-date-format="yyyy-mm-dd" style="width: 100px;"
