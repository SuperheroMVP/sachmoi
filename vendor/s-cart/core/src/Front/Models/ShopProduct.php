...
class ShopProduct extends Model
{
    ...
    */
    ...
    /**
     * [showPercentPrice description]
     * @return [type]           [description]
     */
    public function showPercentPrice()
    {
        if (!sc_config('product_price', $this->store_id)) {
            return false;
        }
       ...
       $percent = ($price_promotion - $price)/$price *100;


        // Process with tax
        return  view('templates.'.sc_store('template').'.common.show_percent_price',
            [
                'percent' => $percent,
            ]
        )->render();
